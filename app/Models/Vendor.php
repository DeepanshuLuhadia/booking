...
class Vendor extends Model
{
    protected $fillable = [
        ...
        'subscription_plan_id', 'subscription_expires_at', 'razorpay_subscription_id', 'razorpay_subscription_status',
        'free_access_until', 'qr_code_path', 'status', 'is_profile_complete',
